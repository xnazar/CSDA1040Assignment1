...
```{r}
#import books csv
books=read.csv(file.choose(), header = TRUE, sep = ";", na.strings = c("NA","","#NA"))
...
```{r}
#import ratings csv
ratings=read.csv(file.choose(), header = TRUE, sep = ";", na.strings = c("NA","","#NA"))
...
```{r}
#import users csv
users=read.csv(file.choose(), header = TRUE, sep = ";", na.strings = c("NA","","#NA"))
